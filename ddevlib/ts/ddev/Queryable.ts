...
export class QueryAble<T> {
    ...
    public static Create<T>(items: T[] | Set<T> | Iterable<T>) {
        ...
        return new QueryAble<T>(null, collection);
    }
    ...
    private _createChild (indexCollection: number[]): QueryAble<T> {
        return new QueryAble<T>(this, indexCollection);
    }
    ...
    public copy () {
        ...
        return new QueryAble<T>(null, items);
    }
